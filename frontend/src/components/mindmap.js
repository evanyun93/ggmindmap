        ...
        <div class="mm-overlay fade-in">
            ...
            <div class="mm-mobile-bar" id="mmMobileBar">
                ...
                <div class="mm-mob-shapes">
                    ...
                    <button class="mm-mob-shape-btn" id="mmMobFreehand">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="M2 2l7.586 7.586"/><circle cx="11" cy="11" r="2"/></svg>
                        그리기
                    </button>
                </div>
