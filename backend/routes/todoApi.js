...
router.patch('/:id/alarm-action', authenticateToken, async (req, res) => {
    try {
        ...
        if (action === 'action_btn1_dismiss' || action === 'action_dismiss' || action === 'dismiss') {
            ...
            `;
        } else if (action === 'action_btn2_snooze' || action === 'action_snooze' || action === 'snooze') {
        ...
        const isSnooze = action.includes('snooze') || action === 'snooze';
